        ...
        <div class="section">
          ...
          <div class="component-group">
            ...
            <div>
              ...
              <Slider 
                value={sliderValue()}
                onChange={(e) => setSliderValue(parseInt(e.currentTarget.value))}
              />
            </div>
            ...
            <div style="margin-bottom: 20px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 12px; max-width: 300px;">
                <TextBox 
                  ...
                  labelPosition="left"
                  value={textBoxValue()}
                  onInput={(e: Event & { currentTarget: HTMLInputElement }) => setTextBoxValue(e.currentTarget.value)}
                ...
                <TextArea 
                  ...
                  labelPosition="top"
                  value={textAreaValue()}
                  onInput={(e: Event & { currentTarget: HTMLTextAreaElement }) => setTextAreaValue(e.currentTarget.value)}
            ...
            <div style="margin-bottom: 20px;">
              ...
              <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                <div>
                  ...
                  <ListView 
                    items={[
                      { id: 'item1', content: 'Documents', selected: selectedListItem() === 'item1' },
                      { id: 'item2', content: 'Pictures', selected: selectedListItem() === 'item2' },
                      { id: 'item3', content: 'Music', selected: selectedListItem() === 'item3' },
                      { id: 'item4', content: 'Videos', selected: selectedListItem() === 'item4' },
                      { id: 'item5', content: 'Downloads (disabled)', disabled: true }
                    ]}
        ...
        <div class="section">
          ...
          <div class="component-group">
            ...
            <div style="position: relative; display: inline-block; margin-bottom: 16px;">
              <Menu 
                items={[
                  { id: 'file', label: 'New File', onClick: () => alert('New File') },
                  { id: 'folder', label: 'New Folder', onClick: () => alert('New Folder') },
                  ...
                  { id: 'properties', label: 'Properties', onClick: () => alert('Properties') },
                  { id: 'disabled', label: 'Disabled Item', disabled: true }
                ]}
              />
            </div>
            
            <p>This context menu demonstrates the proper 7.css styling with dividers and disabled items.</p>
          </div>
        </div>
      )
    }
    ...
    <div class="app">
      ...
      >
        <div class="playground-content">
          ...
          <p>Interactive playground showcasing all SolidJS wrapper components for 7.css</p>
            ...
            items={[
              { 
                ...
                children: [
                  ...
                  { id: 'recent', label: 'Recent Files', children: [
                    { id: 'recent1', label: 'Document1.txt', onClick: () => alert('Recent 1') },
                    { id: 'recent2', label: 'Project.html', onClick: () => alert('Recent 2') },
                    { id: 'recent3', label: 'Style.css', onClick: () => alert('Recent 3') }
                  ]},
                  { id: 'sep1', label: '', divider: true },
                  { id: 'save', label: 'Save', onClick: () => alert('Save') },
                  { id: 'saveas', label: 'Save As...', onClick: () => alert('Save As') },
                  { id: 'sep2', label: '', divider: true },
              ...
              { 
                ...
                children: [
                  ...
                  { id: 'paste', label: 'Paste', onClick: () => alert('Paste') },
                  { id: 'sep2', label: '', divider: true },
                  { id: 'find', label: 'Find', children: [
                    { id: 'findtext', label: 'Find Text...', onClick: () => alert('Find Text') },
                    { id: 'findnext', label: 'Find Next', onClick: () => alert('Find Next') },
                    { id: 'replace', label: 'Replace...', onClick: () => alert('Replace') }
                  ]}
                ]
              },
              { 
                ...
                label: 'View',
                children: [
                  { id: 'toolbar', label: 'Toolbar', onClick: () => alert('Toggle Toolbar') },
                  { id: 'statusbar', label: 'Status Bar', onClick: () => alert('Toggle Status Bar') },
                  { id: 'sep1', label: '', divider: true },
                  { id: 'zoom', label: 'Zoom', children: [
                    { id: 'zoomin', label: 'Zoom In', onClick: () => alert('Zoom In') },
                    { id: 'zoomout', label: 'Zoom Out', onClick: () => alert('Zoom Out') },
                    { id: 'zoom100', label: '100%', onClick: () => alert('100% Zoom') }
                  ]}
                ]
              },
              { 
                ...
                label: 'Help',
                children: [
                  { id: 'docs', label: 'Documentation', onClick: () => alert('Documentation') },
            ...
            <div style="display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 20px;">
              ...
              >
                <div style="padding: 0; margin: 0;">
                  <p style="margin: 8px;">This window has no padding (hasSpace=false).</p>
      ...
      <DialogBox
        ...
        buttons={[
          { id: 'ok', label: 'OK', onClick: () => setShowDialog(false), variant: 'default' },
          { id: 'cancel', label: 'Cancel', onClick: () => setShowDialog(false) }
        ]}
      />
      ...
      >
        <div>
          ...
          <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 20px;">
            <Button variant="default" onClick={() => setShowModal(false)}>Close Modal</Button>
          </div>
        </div>
      </Modal>
